    ...
    <main className="mx-auto max-w-[95rem] space-y-4 px-4 py-8 lg:px-8">
      <div className="space-y-2">
        ...
        <p className="max-w-5xl pt-2 text-base text-slate-700">
          Each column represents condition of the experiment. The data in the table is raw reads count of chimeras
          between snoRNA and mRNA. The Sum_plus_ligation column us the sum of the plus ligation libraries (columns:
          LIGM_REP1, LIGP_REP1, MINUS_UV1, MINUS_UV2, PLUS_UV1, PLUS_V2).
        </p>
      </div>
